...
<p align="center">
  <a href="https://hkjang.github.io/Momento/">🇰🇷 홍보 페이지</a> · <a href="https://hkjang.github.io/Momento/index_en.html">🇺🇸 English Page</a> · <a href="https://hkjang.github.io/">🌐 전체 서비스</a> · <a href="https://github.com/sponsors/hkjang">💖 Sponsor</a>
</p>
...
- 고급 분석: Segment 비교 Funnel·Retention·Web Vitals/오류 경험 비교(전체 대비 완주율 격차와 이탈 단계 지목), Exact/Fast/Preview Query Cost Guard, 중첩 AND/OR Segment Registry, Segment 기반 Query/Funnel, 사용자·세션 전환율, 참여 기준과 활동량이 포함된 Session 요약, 저장된 Exploration
...
릴리스는 `v*` tag push 시 GitHub Actions가 `momento:v<version>` 이미지를 만들어 `momento-v<version>.tar.gz`로 내보내고 Release에 첨부합니다. 이미지는 저장소와 태그(`momento:v0.34.12`), 아카이브는 한 단어(`momento-v0.34.12.tar.gz`)입니다. 소스 번들 또는 온라인 설치 스크립트는 별도 릴리스 자산에 포함하지 않습니다.
